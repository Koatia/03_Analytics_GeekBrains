## 2_SQL-object_creation_simple_selection_queries
...
-- 6
TRUNCATE TABLE genres;  -- ошибка, так как есть связь полей

ALTER TABLE cinema
DROP FOREIGN KEY cinema_ibfk_1;

ALTER TABLE cinema
ADD FOREIGN KEY(genre_id) REFERENCES genres(id) ON DELETE CASCADE; -- с такой связью ошибки удаления не будет (происходит каскадное удаление)

/*
Задача 3
В зависимости от поля “grade”, установите
