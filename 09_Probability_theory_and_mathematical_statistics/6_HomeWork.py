...
print(
    f'>>> Доверительный интервал для величины "X" составляет: [{left:.3f} ; {right:.3f}]'
)
...
print("\nЗадание 3")
print(f">>> Количество измерений роста родителей и детей: {m}, {d}")
...
print(
    f">>> 95% доверительный интервал для разности среднего роста родителей и детей: [{left:.2f}, {right:.2f}]"
)
